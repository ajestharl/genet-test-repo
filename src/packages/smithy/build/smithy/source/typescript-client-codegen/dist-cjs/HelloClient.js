...
exports.HelloClient = exports.__Client = void 0;
...
class HelloClient extends smithy_client_1.Client {
    config;
    constructor(...[configuration]) {
        ...
        this.middlewareStack.use((0, core_1.getHttpAuthSchemePlugin)(this.config, {
            httpAuthSchemeParametersProvider: httpAuthSchemeProvider_1.defaultHelloHttpAuthSchemeParametersProvider, identityProviderConfigProvider: async (config) => new core_1.DefaultIdentityProviderConfig({}),
        }));
