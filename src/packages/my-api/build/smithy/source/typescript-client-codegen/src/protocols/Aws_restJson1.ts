...
import { ExampleServiceException as __BaseException } from "../models/ExampleServiceException";
import { ValidationException } from "../models/models_0";

/**
 * serializeAws_restJson1GetItemCommand
 */
...
/**
 * deserializeAws_restJson1GetItemCommand
 */
...
const de_CommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.example#ValidationException":
